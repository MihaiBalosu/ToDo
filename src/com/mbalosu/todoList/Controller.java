...
public class Controller {
    ...
    public void initialize(){
        ...
        todoList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TodoItem>() {
            ...
            public void changed(ObservableValue<? extends TodoItem> observable, TodoItem oldValue, TodoItem newValue) {
                if(newValue != null){
                    ...
                    DateTimeFormatter dT = DateTimeFormatter.ofPattern("MMMM d, yyyy");
                    deadLineTable.setText(dT.format(item.getDeadLine()));
                }
            }
        });
        ...
        filteredList = new FilteredList<TodoItem>(ToDoData.getInstance().getTodoItem(), wantAllItems);
       ...
       // todoList.setItems(ToDoData.getInstance().getTodoItem());
        ...
        todoList.setCellFactory(new Callback<ListView<TodoItem>, ListCell<TodoItem>>() {
            @Override
    ...
    @FXML
    public  void handlerClickListView() {
        TodoItem item = todoList.getSelectionModel().getSelectedItem();
        textArea.setText(item.getDetail());
        deadLineTable.setText(item.getDeadLine().toString());
    }
